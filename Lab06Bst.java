...
public class Lab06Bst extends Applet
{
    public void paint(Graphics g)
    {
        ...
        for(int count = 1; count <= 1000; count++){
            ...
            int x2 = Expo.random(5,320);
            int y1 = Expo.random(255,495);
            int y2 = Expo.random(5,320);
            Expo.drawLine(g,x1,x2,y1,y2);
        ...
        for (int count = 1; count <= 1000; count++){   
            ...
            int x2 = Expo.random(5,320);
            int y1 = Expo.random(505,745);
            int y2 = Expo.random(5,320);
            Expo.fillRectangle(g,x1,x2,y1,y2);
        }
       ...
       for (int count = 1; count <= 500; count++){
            ...
            int x2 = Expo.random(5,320);
            int y1 = Expo.random(755,995);
            int y2 = Expo.random(5,320);
            int x3 = Expo.random(755,995);
            int y3 = Expo.random(5,320);
            Expo.fillPolygon(g,x1,x2,y1,y2,x3,y3);
        }
        // Draw 100 Random Initials
        for (int count = 1; count <= 100; count++){
            Expo.setRandomColor(g);
            int x = Expo.random(5,175);
            int y = Expo.random(350,645);
            int fontsize = Expo.random(12,36);
            
            Expo.setFont(g,"Arial",Font.PLAIN,fontsize);
            Expo.drawString(g,"BTO",x, y);
